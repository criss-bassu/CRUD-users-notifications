...
public class JwtService {
    private static final String SIGN_KEY = "404E635266556A586E3272357538782F413F4428472B4B6250645367566B5970";
    ...
    public <T> T extractClaim(String token, Function<Claims, T> claimsResolver) {
        return claimsResolver.apply(extractAlClaims(token));
    }
    ...
    public String getUserName(String authenticationHeader) {
